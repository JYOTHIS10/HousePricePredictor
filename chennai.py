...
dataset = pd.read_csv('dataset/chennai.csv')
...
dataset['price_per_sqft'] = dataset['price'] / dataset['total_sqft']
...
# print(predict_price('Devanahalli', 1000, 2, 2))
# print(predict_price('Sarjapur Road', 1000, 3, 3))
# print(predict_price('Kammanahalli', 1000, 3, 3))

# saving the model

with open('cheenai_home_prices_model.pickle', 'wb') as f:
